...
<html>
    ...
    <div class="document">
        ...
        <div class="product-card__container">
            <img class="product-card__container-img"src="hortensie/img/hr.jpg" alt="Hortensie">

        </div>
        <div class="product-card__container">
            <h1 class="product-card__container-name">
                Hortensie <button class="zu-wissen"> 120€❕<span class="zu-wissen__tip">Alle Preise verstehen sich zzgl. MwSt. </span></button>
            </h1>
