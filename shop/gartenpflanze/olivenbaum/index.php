    ...
    <div class="document">
        ...
        <div class="product-card">
            <div class="product-card__container">
                <img class="product-card__container-img"src="olivenbaum/img/olivenbaum.jpg" alt="Olivenbaum">
            </div>
            <div class="product-card__container">
                <h1 class="product-card__container-name">
                Olivenbaum <button class="zu-wissen"> 180€❕<span class="zu-wissen__tip">Alle Preise verstehen sich zzgl. MwSt. </span></button>
                </h1> 
